...
if __name__ == '__main__':
    roitransformer = DetectorModel(r'configs/DOTA1_5/faster_rcnn_RoITrans_r50_fpn_cbam_1x_dota1_5.py',
                  r'save/faster_rcnn_RoITrans_r50_fpn_cbam_1x_dota1_5/epoch_12.pth')

    roitransformer.inference_single_vis(r'demo/P0112.png',
                                       r'demo/faster_rcnn_RoITrans_r50_fpn_cbam_1x_dota1_5/P0112_out.jpg',
                                        (512, 512),
                                       (1024, 1024))
    roitransformer.inference_single_vis(r'demo/P0009.jpg',
                                       r'demo/faster_rcnn_RoITrans_r50_fpn_cbam_1x_dota1_5/P0009_out.jpg',
                                        (512, 512),
                                       (1024, 1024))
    roitransformer.inference_single_vis(r'demo/P0035.png',
                                       r'demo/faster_rcnn_RoITrans_r50_fpn_cbam_1x_dota1_5/P0035_out.jpg',
                                        (512, 512),
                                       (1024, 1024))
